...
namespace KeyboardMouseAPI
{
    ...
    public sealed class InputHelper
    {
        ...
        /// 单击坐标 x, y
        /// </summary>
        /// <param name="x">H</param> 
        /// <param name="y">V</param> 
        /// <param name="a">屏幕分辨率，宽</param> 
        /// <param name="b">屏幕分辨率，高</param> 
        public void ClickOnceAt(int x, int y, int a, int b)
        {
            SetCursorPos(x, y);
            mouse_event(MOUSEEVENTF_LEFTDOWN | MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            //mouse_event(MOUSEEVENTF_MOVE | MOUSEEVENTF_ABSOLUTE, x * 65535 / a, y * 65535 / b, 0, 0);
            //mouse_event(MOUSEEVENTF_LEFTDOWN | MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
        }
        /// <summary>
        /// 鼠标单击当前位置
